...
> - The `user-id` key uses the verified principal stored in metadata. For JWT/PASETO tokens this is the subject claim. Prefer it when authenticated identity is available.
