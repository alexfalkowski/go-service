...
func TestUnary(t *testing.T) {
	Convey("Given I register the health handler", t, func() {
		...
		o := observer(lc, "https://httpstat.us/200", test.NewHTTPClient(lc, logger, test.NewTelemetryConfig(), cfg))
...
func TestInvalidUnary(t *testing.T) {
	Convey("Given I register the health handler", t, func() {
		...
		logger := test.NewLogger(lc)
		cfg := test.NewTransportConfig()
		o := observer(lc, "https://httpstat.us/500", test.NewHTTPClient(lc, logger, test.NewTelemetryConfig(), cfg))
		hs := test.NewHTTPServer(lc, logger, test.NewTelemetryConfig(), cfg)
		gs := test.NewGRPCServer(lc, logger, test.NewTelemetryConfig(), cfg, false, nil, nil)
