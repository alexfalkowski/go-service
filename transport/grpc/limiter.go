...
// NewServerLimiter constructs a gRPC server-side rate limiter when enabled.
//
// This is a small wiring helper that adapts the gRPC transport `Config` to the limiter package constructor.
