...
func NewTracer(params TracerParams) (Tracer, error) {
	return telemetry.NewTracer(telemetry.TracerParams{Lifecycle: params.Lifecycle, Name: "grpc", Version: params.Version, Config: params.Config})
}

// Tracer for telemetry.
type Tracer trace.Tracer

// TracerUnaryServerInterceptor for telemetry.
func TracerUnaryServerInterceptor(tracer Tracer) grpc.UnaryServerInterceptor {
...
// TracerStreamServerInterceptor for telemetry.
func TracerStreamServerInterceptor(tracer Tracer) grpc.StreamServerInterceptor {
...
// TracerUnaryClientInterceptor for telemetry.
func TracerUnaryClientInterceptor(tracer Tracer) grpc.UnaryClientInterceptor {
...
// TracerStreamClientInterceptor for telemetry.
func TracerStreamClientInterceptor(tracer Tracer) grpc.StreamClientInterceptor {
