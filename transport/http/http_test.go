...
func TestUnary(t *testing.T) {
	Convey("Given I have a all the servers", t, func() {
		...
		err := v1.RegisterGreeterServiceHandler(ctx, hs.ServeMux(), conn)
		So(err, ShouldBeNil)
...
func TestValidAuthUnary(t *testing.T) {
	Convey("Given I have a all the servers", t, func() {
		...
		Convey("When I query for an authenticated greet", func() {
			...
			client := test.NewHTTPClientWithRoundTripper(lc, logger, test.NewOTLPTracerConfig(), cfg, transport, m) //nolint:contextcheck
...
func TestMissingAuthUnary(t *testing.T) {
	Convey("Given I have a all the servers", t, func() {
		...
		Convey("When I query for a unauthenticated greet", func() {
			client := test.NewHTTPClient(lc, logger, test.NewOTLPTracerConfig(), cfg, m) //nolint:contextcheck
...
func TestGet(t *testing.T) {
	Convey("Given I have a all the servers", t, func() {
		...
		err = hs.ServeMux().HandlePath("GET", "/hello", func(w http.ResponseWriter, _ *http.Request, _ map[string]string) {
			w.Write([]byte("hello!"))
		})
		So(err, ShouldBeNil)
