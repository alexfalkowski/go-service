...
func verifyConfig(cfg config.Configurator) {
	...
	So(cfg.OAuthConfig().URL, ShouldEqual, "test_url")
	So(cfg.OAuthConfig().ClientID, ShouldEqual, "test_client_id")
	So(cfg.OAuthConfig().ClientSecret, ShouldEqual, "test_client_secret")
	So(cfg.OAuthConfig().Audience, ShouldEqual, "test_audience")
	So(cfg.OAuthConfig().Issuer, ShouldEqual, "test_issuer")
	So(cfg.OAuthConfig().Algorithm, ShouldEqual, "test_algorithm")
	So(cfg.OAuthConfig().JSONWebKeySet, ShouldEqual, "test_json_web_key_set")
