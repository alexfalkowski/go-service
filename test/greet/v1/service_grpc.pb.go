...
func (c *greeterServiceClient) SayStreamHello(ctx context.Context, opts ...grpc.CallOption) (GreeterService_SayStreamHelloClient, error) {
	...
	x := &greeterServiceSayStreamHelloClient{ClientStream: stream}
	return x, nil
}
...
func _GreeterService_SayStreamHello_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreeterServiceServer).SayStreamHello(&greeterServiceSayStreamHelloServer{ServerStream: stream})
}
