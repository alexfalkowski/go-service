...
//     material.
//
// Use [github.com/alexfalkowski/go-service/v2/config/server.NewConfig] and [github.com/alexfalkowski/go-service/v2/config/client.NewConfig] when code needs a
