...
//   - public key: PEM block "PUBLIC KEY" containing PKIX-encoded bytes ([crypto/x509.ParsePKIXPublicKey])
//   - private key: PEM block "PRIVATE KEY" containing PKCS#8-encoded bytes ([crypto/x509.ParsePKCS8PrivateKey])
//
