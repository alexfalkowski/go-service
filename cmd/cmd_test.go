	...
	Convey("Given I have valid configuration", t, func() {
		...
		Convey("When I try to run an application that will shutdown in 5 seconds", func() {
			opts := []fx.Option{
				...
				transport.HTTPModule, transport.HTTPOpentracingModule,
				transport.GRPCModule, transport.GRPCOpentracingModule, transport.NSQMsgPackMarshallerModule,
				transport.NSQModule, transport.NSQOpentracingModule,
